        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h1 className="text-4xl md:text-6xl font-bold mb-6">
              Compare & Choose the Best Electricity Provider
            </h1>
            ...
            <div className="max-w-md mx-auto mb-8">
              <div className="relative">
                <input
                  ...
                  className="w-full px-4 py-4 rounded-lg text-gray-900 text-lg focus:outline-none focus:ring-2 focus:ring-blue-300"
                />
                <button
                  onClick={() => onNavigate('/locations')}
                  className="absolute right-2 top-2 bg-red-600 hover:bg-red-700 text-white px-6 py-2 rounded-lg font-semibold transition-colors"
                >
                  Find Providers
                </button>
              </div>
