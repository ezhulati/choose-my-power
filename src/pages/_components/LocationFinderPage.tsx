              ...
              <div key={index} className="bg-white rounded-lg shadow-sm border hover:shadow-lg transition-shadow overflow-hidden">
                ...
                <div className="p-6">
                  ...
                  <button
                    ...
                    className="w-full bg-texas-navy text-white py-3 rounded-lg hover:bg-texas-navy/90 transition-colors font-medium flex items-center justify-center"
                  >
                ...
                <div className="p-8">
                  ...
                  <div className="grid md:grid-cols-2 gap-3">
                    <button
                      ...
                      className="bg-texas-navy text-white py-3 rounded-lg hover:bg-texas-navy/90 transition-colors font-medium"
                    >
      ...
      <div className="bg-gradient-to-r from-blue-600 to-blue-700 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 text-center">
          ...
          <p className="text-blue-200 text-sm">
            Real plan comparisons. Find your perfect match.
          </p>
        </div>
      </div>
    </div>
