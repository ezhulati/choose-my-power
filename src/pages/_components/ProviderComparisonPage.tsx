          ...
          <div className="grid md:grid-cols-2 gap-8 mb-8">
            <div className="bg-white p-6 rounded-lg shadow-sm border">
              ...
              <button
                ...
                className="w-full mt-4 bg-texas-navy text-white py-2 rounded-lg hover:bg-texas-navy/90 transition-colors"
              >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="bg-texas-navy text-white rounded-lg p-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <button
              onClick={() => navigate('/compare/providers')}
              className="border border-blue-300 text-white px-6 py-3 rounded-lg hover:bg-texas-navy/90 transition-colors font-medium"
            >
              Compare Other Providers
            </button>
          </div>
