            ...
            <div className="bg-texas-cream-200 p-4 rounded-lg">
              ...
              {!zipAnalysis.requiresAddressValidation && (
                <button
                  ...
                  className="mt-3 bg-texas-navy text-white px-4 py-2 rounded hover:bg-texas-navy/90 text-sm"
                >
      ...
      {currentStep === 'address' && (
        <form onSubmit={handleAddressSubmit} className="space-y-4">
          ...
          <div className="flex gap-3">
            ...
            <button
              type="submit"
              className="flex-2 bg-texas-navy text-white px-6 py-3 rounded-lg hover:bg-texas-navy/90 font-medium disabled:opacity-50"
              disabled={isLoading}
            >
