 ...
 * Creates tables one by one to avoid SQL parsing issues
 */
...
async function setupDatabase() {
  ...
  try {
    ...
    console.log('🔄 Creating tdsp table...');
    await sql`
    ...
    console.log('🔄 Creating electricity_plans table...');
    await sql`
    ...
    console.log('🔄 Creating plan_cache table...');
    await sql`
    ...
    console.log('🔄 Creating user_searches table...');
    await sql`
    ...
    console.log('• Test the full system: node scripts/test-database-simple.mjs');
